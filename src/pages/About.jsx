...
import ImageTravel from "../assets/image/about/about.jpg";
    ...
    <div className="about">
      ...
      <div className="about-content w-[1200px] mx-auto flex justify-between items-center py-[100px]">
        <div className="about-content-left w-[48%]">
          <img src={ImageTravel} alt="" className="" />
        </div>
        <div className="about-content-right w-[50%] pl-[20px]">
          <div className="about-content-right-title text-red-500 text-[20px] rotate-[-5deg]">
            About Us
          </div>
          <div className="about-content-right-heading mt-[50px] text-[40px] font-bold">
            World Best Travel Agency Company Since 2005
          </div>
          <div className="about-content-right-desc mt-[15px] text-[#aaaaaa]">
          ...
          <div className="about-content-right-btn mt-[15px]">
            <Link to="/">
              <button className="w-[100px] h-[40px] bg-[#333] rounded-[5px] text-white text-[14px]">
                Go Back
              </button>
            </Link>
          </div>
